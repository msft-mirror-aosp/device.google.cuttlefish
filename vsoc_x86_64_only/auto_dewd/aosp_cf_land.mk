...
# NOTE: this target is not actively maintained or tested, and is only meant to
# be used as a sample on Android V branch. It will not be forward ported to the
# next Android OS versions.
...
PRODUCT_NAME := aosp_cf_x86_64_only_auto_land_dewd
PRODUCT_DEVICE := vsoc_x86_64_only
PRODUCT_MANUFACTURER := Google
PRODUCT_MODEL := Cuttlefish x86_64 auto 64-bit only: Landscape with DEWD
