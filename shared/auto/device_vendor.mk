...
ifeq ($(ENABLE_AUTO_ETHERNET), true)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/macsec/init.wpa_supplicant_macsec_ns.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.wpa_supplicant_macsec_ns.rc
else
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    device/google/cuttlefish/shared/auto/camera/emulated_camera_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/external_camera_config.xml \
    device/google/cuttlefish/shared/auto/camera/ExampleSharedSessionConfiguration.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/shared_session_config.xml
endif
