...
#
$(call inherit-product, device/google/cuttlefish/vsoc_arm64_16k/kernel.mk)
...
PRODUCT_NAME := aosp_cf_arm64_16k_phone
PRODUCT_DEVICE := vsoc_arm64_16k
PRODUCT_MANUFACTURER := Google
PRODUCT_MODEL := Cuttlefish arm64 phone 64-bit only (16k page size)
